...
const Login = () => {
  ...
  // Don't render the form if user is logged in (avoids flash before redirect)
  if (user) return null;
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4" style={{ background: 'radial-gradient(ellipse at top, #1a1730 0%, #07080F 60%)' }}>
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl p-8" style={{ background: 'rgba(15,17,32,0.9)', border: '1px solid rgba(232,184,75,0.2)', boxShadow: '0 0 60px rgba(232,184,75,0.08)' }}>
          ...
          <p className="text-text-muted text-sm mb-8">Sign in to continue watching</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-text-muted text-xs font-medium uppercase tracking-wider">Password</label>
          ...
          <p className="text-text-muted text-sm text-center mt-6">
            ...
            <Link to="/signup" className="text-gold hover:underline font-medium">Create one free</Link>
          </p>
        </div>
      </div>
    </div>
